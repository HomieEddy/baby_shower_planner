...
- E2E: Playwright (`e2e/smoke.spec.ts`) tests guest home, admin login gate + sidebar, guestbook lock. Runs against the dev server (reuses a running one).
