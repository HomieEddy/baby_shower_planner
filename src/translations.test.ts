...
const EMOJI_RE =
  /[\u{1F000}-\u{1FAFF}\u{2600}-\u{27BF}\u{2B00}-\u{2BFF}\u{2728}\u{2705}\u{274C}\u{2753}\u{2764}\u{2763}\u{2795}-\u{2797}\u{2714}\u{2716}\u{271D}\u{267F}\u{2660}-\u{2667}\u{25AA}\u{25AB}\u{25B6}\u{25C0}\u{25FB}-\u{25FE}\u{2757}\u{26A0}\u{26A1}\u{26AA}\u{26AB}\u{2B50}\u{1F1E6}-\u{1F1FF}]/u;
