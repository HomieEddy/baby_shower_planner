  ...
  return (
    <footer className="mt-auto py-2.5 px-4 text-center text-[10px] text-[#5D5449]/80 border-t border-dashed border-[#CBAE94]/60 space-y-1">
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full border border-[#CBAE94]/60 bg-white/60 hover:bg-[#EFE6DC] text-[9px] font-bold font-mono text-[#8B735B] transition-colors cursor-pointer"
